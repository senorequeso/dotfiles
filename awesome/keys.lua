...
keys.globalkeys = gears.table.join( -- Spawn terminal
...
awful.key({}, "Print", function() awful.util.spawn(apps.screenshot, false) end),

-- Screenshot on prtscn using scrot
awful.key({"Shift"}, "Print",
          function() awful.util.spawn(apps.screenshot_box, false) end),
...
awful.key({modkey, "Shift"}, "Down", function(c) move_client(c, "down") end),
awful.key({modkey, "Shift"}, "Up", function(c) move_client(c, "up") end),
awful.key({modkey, "Shift"}, "Left", function(c) move_client(c, "left") end),
awful.key({modkey, "Shift"}, "Right", function(c) move_client(c, "right") end),
